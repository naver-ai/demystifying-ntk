...
def parse_arguments():
    ...
    parser.add_argument('--outdir', default='./results_nb201_train',
    ...
    parser.add_argument('--train_epoch', type=int, default=0, help='start index')
...
if __name__ == '__main__':
    ...
    train_loader, val_loader = get_cifar_dataloaders(args.tr_batch_size, args.val_batch_size, args.dataset, args.num_data_workers)
    ...
    for i, arch_str in enumerate(api):
        ...
        # if math.isnan(measures.get(args.choice).item()):
        ...
        lgc_metrics.append(measures.get(args.choice)[3].item())
        ...
        if len(knas_metrics) == 1001:
            ...
            lgc_test_kt, _ = stats.kendalltau(test_accs, lgc_metrics)
            lgc_test_roh , _ = stats.spearmanr(test_accs, lgc_metrics)

            res['lgc_test_kendall'] = lgc_test_kt
            res['lgc_test_spearman'] = lgc_test_roh
    ...
    lgcscore_filename = os.path.join(save_path, 'lgc_scores.npy')
    ...
    np.save(lgcscore_filename, lgc_metrics)
